...
from app.api.v1 import analytics, assignments, auth, curriculum, exams, parents, students, writing
...
from app.api.v1.admin import quality as admin_quality
...
from app.api.v1.admin import writing as admin_writing
...
router.include_router(admin_writing.router)
